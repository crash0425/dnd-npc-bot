...
FONT_DIR = os.path.dirname(__file__)  # Fonts in project root
...
def create_volume_pdf(volume_npcs, volume_number):
    ...
    prompt = (
        "Epic fantasy tavern interior, warm lighting, cozy but grand, filled with mysterious travelers, "
        "detailed environment, fantasy art style, cinematic, ultra-detailed"
    )
